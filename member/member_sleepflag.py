    ...
    def start_serving(self):
        ...
        try:
            ...
            while self.running:
                ...
                while self.state == State.leader and self.running is True and self.SleepFlag is False:
                        self.do_leader_message_listening()

                # If you are a follower, listen for heartbeat messages
                while self.state == State.follower and self.running is True and self.SleepFlag is False:
                        self.do_follower_message_listening()

                # If you are a candidate, request votes until you are elected or detect a new leader
                while self.state == State.candidate and self.running is True and self.SleepFlag is False:
